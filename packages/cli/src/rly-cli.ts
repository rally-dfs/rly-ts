...
program
  ...
  .option("-v, --version <number>", "canonical token version", "3")
  .requiredOption(
    "-k, --keypair <path>",
    `Solana wallet location`,
    "--keypair not provided"
...
program
  ...
  .requiredOption("--slope_numerator <string>", "slope numerator")
  .requiredOption("--slope_denominator <string>", "slope denominator")
  .requiredOption("--init_price_a_numerator <string>", "initial price token A")
  .requiredOption(
    "--init_price_a_denominator <string>",
    "initial price token B"
  )
  .description(
    "initialize a new token bonding curve with the specified parameters"
  )
...
program
  ...
  .description(
    "estimate the result of swapping two tokens on a given token bonding curve"
  )
